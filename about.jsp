			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="รอมลี สาและ" class="rounded-circle shadow" width="140" height="140" src="assets/img/a.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>รอมลี สาและ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010027</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/alavi.salah.9" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @อาลาวี </a></p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="ซาบาวี แยนา" class="rounded-circle shadow" width="140" height="140" src="assets/img/s.jpg" />
						<h5 class="pt-4 mb-3">ผู้ช่วยพัฒนาระบบ</h5>
						<h2>ซาบาวี แยนา</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010022</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/profile.php?id=100010349434236" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @ว้าววีย์' แบ๊ง'</a></p>
					</div>
					<div class="col-lg-4 pb-4">
